...
export default function Page() {
    return (
        <LegalPage>
            ...
            <p>The app is ran on Vercel (serverless, stateless) with /recordUsage and /queryUsage data being stored in Vercel Storage in Germany, Frankfurt. The access to the internet (DNS, reverse proxy) is managed by Cloudflare.</p>
